        ...
        children: <Widget>[
            ...
            child: Padding(
              ...
              child: Row(
                ...
                children: <Widget>[
                  ...
                  Spacer(), // Takes all the available space between the widget above it(i.e Text()) and the widgets below it(i.e Chip and FlatButton)
                  Chip(
          ...
          Expanded(child: ListView.builder(
            ...
            itemBuilder: (ctx, i) => CartItem(
                cart.items.values.toList()[i].id,       // since items is a Map so we need to convert it to List
                cart.items.keys.toList()[i],        // this is the key of the map, ie productId
  ...
  Widget build(BuildContext context) {
    return FlatButton(
      onPressed: (widget.cart.totalAmount <=0 || _isLoading)
        ...
        widget.cart.clear();   // To clear the cart
      },
